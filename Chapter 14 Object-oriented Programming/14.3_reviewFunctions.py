...
# Within the program are several process;
...
# With O-OP, complex systems can br broken into parts. The parts of 
# BeautifulSoup library is ignored and the using the program only 
